...
namespace Movie_DataBase
{
    public partial class Form10 : Form
    {
        ...
        public Form10(SqlConnection myConn, string numberGenre, string nameGenre)
        {
            InitializeComponent();
            this.myConn = myConn;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand myComm = new SqlCommand("UPDATE dbo.Жанр SET Жанр = @p1 where idЖанр = @p2", myConn);
